...
import { ColorScheme, LayoutService, MenuMode } from '../services/layout.service';
...
export class ConfigComponent implements OnInit {
  ...
  ngOnInit() {
    this.componentThemes = [
      ...
      {
        name: 'amethyst',
        color: 'rgb(131, 76, 168)'
      },
      {
        name: 'wedgewood',
        color: 'rgb(85, 125, 170)'
      },
      {
        name: 'tapestry',
        color: 'rgb(167, 72, 150)'
      },
      {
        name: 'cape-palliser',
